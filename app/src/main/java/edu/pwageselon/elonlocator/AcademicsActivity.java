...
public class AcademicsActivity extends Activity {
    ...
    private final String fileName = "AcademicData.csv";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.listviewacademics);
    ...
    AdapterView.OnItemClickListener onItemClickListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    Intent intent = new Intent(AcademicsActivity.this, DialogActivity.class);
